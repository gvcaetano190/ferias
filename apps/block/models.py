...
class BlockProcessing(models.Model):
    ...
    totvs_status = models.CharField(max_length=50, blank=True)
...
class BlockVerificationItem(models.Model):
    ...
    totvs_status_banco_antes = models.CharField(max_length=50, blank=True)
    ad_status_real = models.CharField(max_length=50, blank=True)
    vpn_status_real = models.CharField(max_length=50, blank=True)
    totvs_status_real = models.CharField(max_length=50, blank=True)
    ...
    totvs_status_banco_depois = models.CharField(max_length=50, blank=True)
